...
function cadastrar(nomeFantasia, cnpj, RazaoSocial, telefone, email, senha, rua, bairro, cidade, estado, cep) {
    ...
    var instrucao = `
        INSERT INTO empresa (NomeFantasia, CNPJ, RazaoSocial, Telefone, Email, Senha, Rua, Bairro, Cidade, Estado, CEP) VALUES ('${nomeFantasia}', '${cnpj}', '${RazaoSocial}', '${telefone}', '${email}', '${senha}', '${rua}', '${bairro}', '${cidade}', '${estado}', '${cep}');
    `;
    console.log("Executando a instrução SQL: \n" + instrucao);
    return database.executar(instrucao);
}
